  ...
  return (
    <div id="container">
        ...
        <div className="landing-slide-three">
            ...
            <RedirectButton path="/courses" className="buttonSpacing">Available Courses</RedirectButton>
            <hr/>
            <RedirectButton path="/login" className="buttonSpacing">Login</RedirectButton>
            </div>
            <h1>Government Access</h1>
            <div className="form-group has-feedback has-feedback-left">
                <RedirectButton path="" className="buttonSpacing">View Special Pricing Options</RedirectButton>
            </div>
            <h1>Learn More About Us!</h1>
            <div className="form-group has-feedback has-feedback-left">
                <RedirectButton path="" className="buttonSpacing">About Us</RedirectButton>
                <hr/>
                <RedirectButton path="" className="buttonSpacing">LinkedIn</RedirectButton>
            </div>
        </div>
    </div>
  );
